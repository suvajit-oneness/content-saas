                    ...
                    <form action="{{ route('front.portfolio.profile.update') }}" method="POST" role="form"
                        ...
                        <div class="tile-body">
                            <div class="form-group">
                                ...
                                @error('first_name')
                                    <p class="m-l-5 text-danger">{{ $message }}</p>
                                @enderror
                            </div><br>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="control-label" for="short_desc">Short Description <span>(optional)</span></label>
                            ...
                            <div class="form-group">
                                <label class="control-label" for="country">
                                    ...
                                    <p class="m-l-5 text-muted">(You can select multiple)</p>
                                </label>
                                <br>
                            ...
                            <br>
                            <div class="form-group">
                                <label class="control-label" for="quote">Favourite Quote <span>(optional)</span></label>
                            ...
                            <br>
                            <div class="form-group">
                                <label class="control-label" for="quote_by">Quote By <span>(optional)</span></label>
                            ...
                            <br>
                            <div class="form-group">
                                <label class="control-label" for="social_media_id">Social media <span>(optional)</span></label>
                            ...
                            <div class="form-group">
                                <label class="control-label" for="color_scheme">Color Scheme <span>(optional)</span></label>
                        ...
                        <div class="form-group">
                            <label class="control-label" for="worked_for">Worked For <span class="m-l-5 text-danger">*</span><p><small>(Comma separated values)</small></p></label>
                        ...
                        <div class="form-group">
                            <label class="control-label" for="categories">Category <span class="m-l-5 text-danger">*</span><p><small>(Comma separated values)</small></p></label>
