            ...
            <div class="col-12">
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th class="table-tab active" onclick="location.href='{{ route('front.portfolio.certification.index')}}'">Certification </th>
                ...
                <div class="table-responsive table-content">
                    <table class="table table-hovered table-striped">
                        <tbody class="tbody-content tbody-content-edit" id="certificate" style="display:block;">
                                <tr>
                                    <td>
                                        <div class="action">
