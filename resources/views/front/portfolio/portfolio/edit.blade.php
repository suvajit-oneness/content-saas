                                            ...
                                            *</span></label>
                                            <select class="form-control" name="category">
                                                ...
                                                @foreach ($category as $index => $item)
                                                    <option value="{{ $item->title }}{{ ($portfolio->category==$item->category) ? 'selected' : '' }}">{{ $item->title }}</option>
                                                @endforeach
                                        </select>
                                        ...
                                        <div class="col-md-2">
                                            @if ($portfolio->image != null)
                                                <figure class="mt-2" style="width: 80px; height: auto;">
                                                    <img src="{{ asset('uploads/portfolio/'.$portfolio->image) }}" id="articleImage" class="img-fluid" alt="">
                                                </figure>
                                            @endif
                                        </div>
                                    <div class="col-md-10">
