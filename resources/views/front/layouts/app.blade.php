...
<html lang="en">
    ...
    <body>
		<nav class="navbar navbar-expand-xl navbar-light fixed-top">
			<div class="container">
			    <a class="navbar-brand" href="{{ route('front.index') }}"><img src="{{ asset('frontend/img/logo.png') }}"></a>
			    ...
			    <div div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('article*') ? 'active' : '' }}" href="{{ route('front.article') }}">Blog</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            @php
                                ...
                                if ($cartExists) {
                                    $cartCount = DB::table('carts')->where('ip', $ip)->get();
                                    $totalCartProducts = 0;
                            ...
                            <a class="nav-link {{ request()->is('cart') ? 'active' : '' }}" href="{{ route('front.cart') }}">
			...
			<div class="container">
				<div class="row justify-content-between">
					...
					<div class="col-12 col-lg-7 col-md-7 mb-3 mb-lg-5 mb-md-4">
						...
						<a href="javascript:void(0);">Get Started Now<img src="{{ asset('frontend/img/next_icon.png') }}"></a>
