    ...
    <div class="app-title">
        <div class="row w-100 mx-0">
            ...
            <div class="col-md-6 text-right">
                <a href="{{ route('admin.deals.category.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Create New</a>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row mx-0 align-items-center justify-content-between">
                <div class="col">
                    <p class="text-muted">Total Number of Records ({{$deals_category->total()}})</p>
                </div>
                <div class="col-auto">
                    <form action="">
            ...
            <div class="tile">
                <div class="tile-body">
                    ...
                    <table class="table table-hover custom-data-table-style table-striped">
                        ...
                        <tbody>
                            @foreach($deals_category as $key => $data)
                                <tr>
                                    <td>{{ $key+1 }}</td>
                                    <td>
                                        <img style="height: 100px;" src="{{ asset($data->image) }}">
                                    </td>
                                    <td>{{ $data->title }}</td>
                                    <td>
                                        {!! $data->description !!}
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group" aria-label="Second group">
                                            <a href="{{ route('admin.deals.category.edit', $data['id']) }}" class="btn btn-sm btn-primary edit-btn"><i class="fa fa-edit"></i></a>
    ...
    <script type="text/javascript">
        ...
        $('input[id="toggle-block"]').change(function() {
          ...
          $.ajax({
                type:'POST',
                dataType:'JSON',
                url:"{{route('admin.deals.category.updateStatus')}}",
