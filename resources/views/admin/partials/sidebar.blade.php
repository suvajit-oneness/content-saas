...
<aside class="app-sidebar">
    <ul class="app-menu">
        ...
        <div id="collapseOne" class="collapse @if(request()->is('admin/event')|| request()->is('admin/event/category'))) {{ 'show' }} @endif" aria-labelledby="headingOne" data-parent="#accordion">
            <li>
        ...
        <div id="collapseThree" class="collapse @if(request()->is('admin/course*')) {{ 'show' }} @endif" aria-labelledby="headingOne" data-parent="#accordion">
            <li>
        ...
        <div id="collapseFour" class="collapse @if(request()->is('admin/category') || request()->is('admin/subcategory') || request()->is('admin/tertiary') || request()->is('admin/article')) {{ 'show' }} @endif" aria-labelledby="headingOne" data-parent="#accordion">
            <li>
        ...
        <div id="collapseFive" class="collapse @if(request()->is('admin/marketplace')) {{ 'show' }} @endif" aria-labelledby="headingOne" data-parent="#accordion">
            <li>
        ...
        <div id="collapseSix" class="collapse @if(request()->is('admin/market') || request()->is('admin/market/category') || request()->is('admin/market/banner') || request()->is('admin/market/faq')) {{ 'show' }} @endif" aria-labelledby="headingOne" data-parent="#accordion">
                <!--- Category management --->
            <li>
        ...
        <li class="text-light" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="true" aria-controls="collapseSeven">
            <a href="#" class="app-menu__item @if(request()->is('admin/support') || request()->is('admin/support/widget') || request()->is('admin/support/faq/category') || request()->is('admin/support/faq')) {{ 'active' }} @endif">
                <span class="app-menu__label">Support Master</span>
                <i class="app-menu__icon fa fa-chevron-down"></i>
            </a>
        </li>
        <div id="collapseSeven" class="collapse @if(request()->is('admin/support') || request()->is('admin/support/widget') || request()->is('admin/support/faq/category') || request()->is('admin/support/faq')) {{ 'show' }} @endif" aria-labelledby="headingOne" data-parent="#accordion">
                <!--- Category management --->
            <li>
        ...
        <!-- Event Management -->
        <li class="text-light" data-toggle="collapse" data-target="#collapseEight" aria-expanded="true" aria-controls="collapseEight">
        ...
        <div id="collapseEight" class="collapse @if(request()->is('admin/orders*')) {{ 'show' }} @endif" aria-labelledby="headingEight" data-parent="#accordion">
            {{-- Orders --}}
            <li>
         ...
         <!-- Job Management -->
         <li class="text-light" data-toggle="collapse" data-target="#collapseNine" aria-expanded="true" aria-controls="collapseNine">
        ...
        <div id="collapseNine" class="collapse @if(request()->is('admin/job*')) {{ 'show' }} @endif" aria-labelledby="headingOne" data-parent="#accordion">
            <li>
        ...
        <!-- Template Management -->
        <li class="text-light" data-toggle="collapse" data-target="#collapseTen" aria-expanded="true" aria-controls="collapseTen">
            <a href="#" class="app-menu__item @if(request()->is('admin/template/category') || request()->is('admin/template/subcategory') || request()->is('admin/template/type') || request()->is('admin/template')) {{ 'active' }} @endif">
                <span class="app-menu__label">Template Master</span>
                <i class="app-menu__icon fa fa-chevron-down"></i>
            </a>
        </li>

        <div id="collapseTen" class="collapse @if(request()->is('admin/template/category') || request()->is('admin/template/subcategory') || request()->is('admin/template/type') || request()->is('admin/template')) {{ 'show' }} @endif" aria-labelledby="headingOne" data-parent="#accordion">
            <li>
                <a class="app-menu__item {{ request()->is('admin/template/category') ? 'active' : '' }}" href="{{ route('admin.template.category.index') }}">
                    <i class="app-menu__icon fa fa-archive"></i>
                    <span class="app-menu__label">Category</span>
                 </a>
            </li>
            <li>
                <a class="app-menu__item {{ request()->is('admin/template/subcategory') ? 'active' : '' }}" href="{{ route('admin.template.subcategory.index') }}"><i class="app-menu__icon fa fa-cogs"></i>
                    <span class="app-menu__label">Subcategory</span>
                </a>
            </li>
            <li>
                <a class="app-menu__item {{ request()->is('admin/template/type') ? 'active' : '' }}" href="{{ route('admin.template.type.index') }}"><i class="app-menu__icon fa fa-cogs"></i>
                    <span class="app-menu__label">Type</span>
                </a>
            </li>
            <li>
                <a class="app-menu__item {{ request()->is('admin/template') ? 'active' : '' }}" href="{{ route('admin.template.index') }}"><i class="app-menu__icon fa fa-cogs"></i>
                    <span class="app-menu__label">Template</span>
                </a>
            </li>
        </div>
    </ul>
