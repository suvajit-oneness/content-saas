    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row mx-0 align-items-center justify-content-between">
                <div class="col">
                    <p class="text-muted">Total Number of Records ({{$lessons->total()}})</p>
                </div>
                <div class="col-auto">
                    <form action="">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group" aria-label="Second group">
                                            <a href="{{ route('admin.lesson.edit', $data['id']) }}" class="btn btn-sm btn-primary edit-btn"><i class="fa fa-edit"></i></a>
                                            <a href="{{ route('admin.lesson.details', $data['id']) }}" class="btn btn-sm btn-primary edit-btn"><i class="fa fa-eye"></i></a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('admin.lesson.data.csv.store')}}" enctype="multipart/form-data" id="fileCsvUploadForm">
                        @csrf
...
@push('scripts')
    ...
    <script type="text/javascript">
        $('.sa-remove').on("click",function(){
            ...
            function(isConfirm){
            if (isConfirm) {
                window.location.href = "lesson/"+id+"/delete";
                } else {
        ...
        $('input[id="toggle-block"]').change(function() {
          ...
          $.ajax({
                type:'POST',
                dataType:'JSON',
                url:"{{route('admin.lesson.updateStatus')}}",
