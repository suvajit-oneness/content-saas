        ...
        <div class="col-md-8 mx-auto">
            <div class="tile">
                <div class="d-flex justify-content-between my-2">
                    ...
                    <a class="btn btn-secondary" href="{{ route('admin.article.page.index') }}">
                        <i class="fa fa-fw fa-lg fa-times-circle"></i>Back
                    </a>
                </div>
                <form action="{{ route('admin.article.page.update') }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" value="{{$article_page->id}}">
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <textarea class="form-control summernote @error('header_left') is-invalid @enderror" type="text" name="header_left"
                                id="header_left"> {{ old('header_left', $article_page->header_left) }} </textarea>
                        ...
                        <div class="form-group">
                            <label class="control-label" for="header_right">Header Right Content <span class="m-l-5 text-danger">
                                ...
                                <textarea class="form-control summernote @error('header_right') is-invalid @enderror" type="text" name="header_right"
                                    id="header_right"> {{ old('header_right', $article_page->header_right) }} </textarea>
                    ...
                    <div class="tile-footer">
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <a class="btn btn-secondary" href="{{ route('admin.article.page.index') }}"><i
