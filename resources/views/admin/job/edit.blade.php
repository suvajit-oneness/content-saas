                ...
                <form action="{{ route('admin.job.update') }}" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <select name="category_id" id="category" class="form-control @error('category') is-invalid @enderror">
                                ...
                                @foreach ($categories as $category)
                                    <option value="{{ $category->id }}" {{ ( $category->id == $Job->category_id ) ? 'selected' : '' }}>{{ucwords($category->title) }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('title') is-invalid @enderror" type="text" name="title" id="title" value="{{ old('title',$Job->title) }}" />
                        ...
                        <div class="form-group">
                            ...
                            *</span></label><br>
                            ...
                            <select name="employment_type"  
                                        ...
                                        <option value="fulltime" {{ ($Job->employment_type) == "fulltime" ? 'selected' : '' }}>Full time</option>
                                        <option value="parttime" {{ ($Job->employment_type) == "parttime" ? 'selected' : '' }}>Part time</option>
                                        <option value="remote" {{ ($Job->employment_type) == "remote" ? 'selected' : '' }}>Remote</option>
                                        <option value="telecommute" {{ ($Job->employment_type) == "telecommute" ? 'selected' : '' }}>Telecommute</option>
                                        ...
                                        <option value="unpaid" {{ ($Job->employment_type) == "unpaid" ? 'selected' : '' }}>Unpaid</option>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @error('location') is-invalid @enderror" type="text" name="location" id="location" value="{{ old('location',$Job->location) }}" />
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('start_date') is-invalid @enderror" type="date"
                                        name="start_date" id="start_date" value="{{ old('start_date',$Job->start_date) }}" />
                        ...
                        <div class="form-group">
                                ...
                                <input class="form-control @error('tag') is-invalid @enderror" type="text" name="tag" id="tag" value="{{ old('tag',$Job->tag) }}" />
                                ...
                                <div class="col-md-2">
                                    @if ($Job->image != null)
                                        <figure class="mt-2" style="width: 80px; height: auto;">
                                            <img src="{{ asset($Job->image) }}" id="blogImage" class="img-fluid" alt="img">
                                        </figure>
                                    @endif
                                </div>
                        <div class="form-group">
