                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="category_id">
                                ...
                                @foreach ($categories as $index => $item)
                                    <option value="{{ $item->id }}" {{ ($item->id == $targetcourse->category_id) ? 'selected' : '' }}>{{ $item->title }}</option>
                                @endforeach
                            </select>
                            @error('category_id')
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('course_name') is-invalid @enderror" type="text" name="course_name"
                                id="course_name" value="{{ old('course_name' ,$targetcourse->course_name ) }}" />
                            @error('course_name')
                                <p class="small text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                                ...
                                <div class="col-md-2">
                                    @if ($targetcourse->image != null)
                                        <figure class="mt-2" style="width: 80px; height: auto;">
                                            <img src="{{ asset('course/'.$targetcourse->image) }}" id="blogImage" class="img-fluid" alt="img">
                                        </figure>
                                    @endif
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" rows="4" name="short_description" id="short_description">{{ old('short_description', $targetcourse->short_description) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" rows="4" name="description" id="description">{{ old('description', $targetcourse->description) }}</textarea>
                            @error('description')
                                <p class="small text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input class="form-control" rows="4" name="company_name" id="company_name"
                                value="{{ old('company_name',$targetcourse->company_name) }}" />
                            @error('company_name')
                                <p class="small text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input class="form-control" rows="4" name="company_description"
                                id="company_description" value="{{ old('company_description',$targetcourse->company_description) }}"/>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" rows="4" name="author_name" multiple
                                id="author_name" value="{{ old('author_name' ,$targetcourse->author_name) }}"/>
                            @error('author_name')
                                <p class="small text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" rows="4" name="author_description" id="author_description">{{ old('author_description' ,$targetcourse->author_description) }}</textarea>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-2">
                                    @if ($targetcourse->author_image != null)
                                        <figure class="mt-2" style="width: 80px; height: auto;">
                                            <img src="{{ asset('course/'.$targetcourse->author_image) }}" id="blogImage" class="img-fluid" alt="img">
                                        </figure>
                                    @endif
                                </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" rows="4" name="language" multiple
                                id="language" value="{{ old('language',$targetcourse->language) }} "/>
                            @error('language')
                                <p class="small text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input class="form-control" rows="4" name="requirements" multiple
                                id="requirements" value="{{ old('requirements' ,$targetcourse->requirements) }} "/>
                            @error('requirements')
                                <p class="small text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input class="form-control" rows="4" name="target" multiple
                                id="target" value="{{ old('target' ,$targetcourse->target) }} "/>
                            @error('target')
                                <p class="small text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <select name="type" id="type" class="form-control @error('type') is-invalid @enderror">
                                ...
                                <option value="1" {{ (1 == $targetcourse->type) ? 'selected' : '' }}>Paid</option>
                                <option value="2" {{ (2 == $targetcourse->type) ? 'selected' : '' }}>Free</option>
                            </select>
                            @error('author_name')
                                <p class="small text-danger">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" rows="4" name="price" multiple
                                id="price" value="{{ old('price' ,$targetcourse->price) }} "/>
                            @error('price')
                                <p class="small text-danger">{{ $message }}</p>
                            @enderror
                        </div>
