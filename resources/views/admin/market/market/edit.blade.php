                ...
                <form action="{{ route('admin.market.update') }}" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('tag') is-invalid @enderror" type="text" name="tag" id="tag" value="{{ old('tag',$targetmarket->tag) }}"/>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('title') is-invalid @enderror" type="text" name="title" id="title" value="{{ old('title',$targetmarket->title) }}"/>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('short_description') is-invalid @enderror" type="text" name="short_description" id="short_description" value="{{ old('short_description',$targetmarket->short_description) }}"/>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('market_btn') is-invalid @enderror" type="text" name="market_btn" id="market_btn" value="{{ old('market_btn',$targetmarket->market_btn) }}"/>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('market_btn_link') is-invalid @enderror" type="text" name="market_btn_link" id="market_btn_link" value="{{ old('market_btn_link',$targetmarket->market_btn_link) }}"/>
                            ...
                            <div class="col-md-2">
                                @if ($targetmarket->image != null)
                                    <figure class="mt-2" style="width: 80px; height: auto;">
                                        <img src="{{ asset('/uploads/market/'.$targetmarket->image) }}" id="blogImage" class="img-fluid" alt="img">
                                    </figure>
                                @endif
                            </div>
                            <div class="col-md-10">
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('short_content_heading') is-invalid @enderror" type="text" name="short_content_heading" id="short_content_heading" value="{{ old('short_content_heading',$targetmarket->short_content_heading) }}"/>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('short_content_btn') is-invalid @enderror" type="text" name="short_content_btn" id="short_content_btn" value="{{ old('short_content_btn',$targetmarket->short_content_btn) }}"/>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('short_content_btn_link') is-invalid @enderror" type="text" name="short_content_btn_link" id="short_content_btn_link" value="{{ old('short_content_btn_link',$targetmarket->short_content_btn_link) }}"/>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('sticky_content_heading') is-invalid @enderror" type="text" name="sticky_content_heading" id="sticky_content_heading" value="{{ old('sticky_content_heading',$targetmarket->sticky_content_heading) }}"/>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('sticky_content_btn') is-invalid @enderror" type="text" name="sticky_content_btn" id="sticky_content_btn" value="{{ old('sticky_content_btn',$targetmarket->sticky_content_btn) }}"/>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('sticky_content_btn_link') is-invalid @enderror" type="text" name="sticky_content_btn_link" id="sticky_content_btn_link" value="{{ old('sticky_content_btn_link',$targetmarket->sticky_content_btn_link) }}"/>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('medium_content_heading') is-invalid @enderror" type="text" name="medium_content_heading" id="medium_content_heading" value="{{ old('medium_content_heading',$targetmarket->medium_content_heading) }}"/>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('faq_heading') is-invalid @enderror" type="text" name="faq_heading" id="faq_heading" value="{{ old('faq_heading',$targetmarket->faq_heading) }}"/>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('blog_heading') is-invalid @enderror" type="text" name="blog_heading" id="blog_heading" value="{{ old('blog_heading',$targetmarket->blog_heading) }}"/>
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                @if ($targetmarket->faq_banner_image != null)
                                    <figure class="mt-2" style="width: 80px; height: auto;">
                                        <img src="{{ asset('/uploads/market/'.$targetmarket->faq_banner_image) }}" id="blogImage" class="img-fluid" alt="img">
                                    </figure>
                                @endif
                            </div>
                            <div class="col-md-10">
                                <label class="control-label"> Image</label>
                                <input class="form-control @error('faq_banner_image') is-invalid @enderror" type="file" id="faq_banner_image" name="faq_banner_image"/>
                                @error('faq_banner_image') {{ $message }} @enderror
                            </div>
                        </div>
                    </div>
