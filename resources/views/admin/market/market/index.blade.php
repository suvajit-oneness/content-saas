    ...
    <div class="app-title">
        <div class="row w-100">
            ...
            <div class="col-md-6 text-right">
                 {{-- <a href="{{ route('admin.market.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>
                ...
                <div class="tile-body">
                    <table class="table table-hover custom-data-table-style table-striped">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th><i class="fi fi-br-picture"></i>Main Image</th>
                                <th> Tag </th>
                                <th> Title </th>
                                <th> Status </th>
...
@push('scripts')
    ...
    $('.sa-remove').on("click",function(){
        ...
        function(isConfirm){
          if (isConfirm) {
            window.location.href = "https://demo91.co.in/laravel-only/ContentSaas/public/admin/market/"+categoryid+"/delete";
            } else {
    ...
    <script type="text/javascript">
        $('input[id="toggle-block"]').change(function() {
          ...
          $.ajax({
                type:'POST',
                dataType:'JSON',
                url:"{{route('admin.market.updateStatus')}}",
