    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-auto">
                    <form action="{{ route('admin.market.banner.index') }}">
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-auto">
                        <button type="submit" class="btn btn-outline-danger btn-sm">Search banner</button>
            ...
            <div class="tile">
                <div class="tile-body">
                    <table class="table table-hover custom-data-table-style table-striped">
                        ...
                        <tbody>
                            @foreach($categories as $key => $banner)
                                <tr>
                                    <td>{{ $key+1 }}</td>
                                    <td>
                                        @if($banner->image!='')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('admin.market.banner.data.csv.store')}}" enctype="multipart/form-data" id="fileCsvUploadForm">
                        @csrf
...
@push('scripts')
    ...
    $('.sa-remove').on("click",function(){
        ...
        function(isConfirm){
          if (isConfirm) {
            window.location.href = "https://demo91.co.in/laravel-only/ContentSaas/public/admin/market/banner/"+bannerid+"/delete";
            } else {
    ...
    <script type="text/javascript">
        $('input[id="toggle-block"]').change(function() {
          ...
          $.ajax({
                type:'POST',
                dataType:'JSON',
                url:"{{route('admin.market.banner.updateStatus')}}",
