    ...
    <div class="app-title">
        <div class="row w-100 mx-0">
            ...
            <div class="col-md-6 text-right">
                <a href="{{ route('admin.plans.category.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Create New</a>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row mx-0 align-items-center justify-content-between">
                <div class="col">
                    <p class="text-muted">Total Number of Records ({{$plans_price_category->total()}})</p>
                </div>
                <div class="col-auto">
                    <form action="">
            ...
            <div class="tile">
                <div class="tile-body">
                    ...
                    <table class="table table-hover custom-data-table-style table-striped">
                        ...
                        <tbody>
                            @foreach($plans_price_category as $key => $data)
                                <tr>
                                    <td>{{ $key+1 }}</td>
                                    <td>{{ $data->currency }}</td>
                                    <td>
