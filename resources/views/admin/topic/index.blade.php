    ...
    <div class="app-title">
        <div class="row w-100 mx-0">
            ...
            <div class="col-md-6 text-right">
                ...
                <a href="{{ route('admin.topic.data.csv.export') }}" class="btn btn-primary "><i class="fa fa-cloud-download"></i> CSV Export</a>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row mx-0 align-items-center justify-content-between">
                <div class="col">
                    <p class="text-muted">Total Number of Records ({{$data->total()}})</p>
                </div>
                <div class="col-auto">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('admin.topic.data.csv.store')}}" enctype="multipart/form-data" id="fileCsvUploadForm">
                        @csrf
                        ...
                        <button type="submit" class="btn btn-sm btn-primary" id="csvImportBtn">Import <i class="fas fa-upload"></i></button>
                         <p><a href="{{URL::to('/')}}/admin/csvexample/topic.csv" target="_blank">
...
@push('scripts')
    ...
    <script type="text/javascript">
        $('.sa-remove').on("click",function(){
            ...
            function(isConfirm){
            if (isConfirm) {
                window.location.href = "topic/"+id+"/delete";
                } else {
