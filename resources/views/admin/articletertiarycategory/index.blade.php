    ...
    <div class="app-title">
        <div class="row w-100">
            ...
            <div class="col-md-6 text-right">
                <a href="{{ route('admin.article-tertiary.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>
        ...
        <div class="col-md-12">
            <div class="col-md-12">
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-auto">
                        <form action="{{ route('admin.article-tertiary.index') }}">
                            ...
                            @foreach($subcatlevel as $key => $category)
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group" aria-label="Second group">
                                        <a href="{{ route('admin.article-tertiary.edit', $category['id']) }}" class="btn btn-sm btn-primary edit-btn"><i class="fa fa-edit"></i></a>
                                        <a href="{{ route('admin.article-tertiary.details', $category['id']) }}" class="btn btn-sm btn-primary edit-btn"><i class="fa fa-eye"></i></a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('admin.article-tertiary.data.csv.store')}}" enctype="multipart/form-data" id="fileCsvUploadForm">
                        @csrf
...
@push('scripts')
    ...
    $('.sa-remove').on("click",function(){
        ...
        function(isConfirm){
          if (isConfirm) {
            window.location.href = "article-tertiary/"+id+"/delete";
            } else {
     ...
     <script type="text/javascript">
        $('input[id="toggle-block"]').change(function() {
          ...
          $.ajax({
                type:'POST',
                dataType:'JSON',
                url:"{{route('admin.article-tertiary.updateStatus')}}",
