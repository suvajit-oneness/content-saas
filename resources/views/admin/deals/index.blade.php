    ...
    <div class="app-title">
        <div class="row w-100 mx-0">
            ...
            <div class="col-md-6 text-right">
                <a href="{{ route('admin.deals.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Create New</a>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row mx-0 align-items-center justify-content-between">
                <div class="col">
                    <p class="text-muted">Total Number of Records ({{$deals->total()}})</p>
                </div>
                <div class="col-auto">
                    <form action="">
    ...
    <script type="text/javascript">
        ...
        $('input[id="toggle-block"]').change(function() {
          ...
          $.ajax({
                type:'POST',
                dataType:'JSON',
                url:"{{route('admin.deals.updateStatus')}}",
