        ...
        <div class="col-md-8 mx-auto">
            <div class="tile">
                <div class="d-flex justify-content-between my-2">
                    ...
                    <a class="btn btn-secondary" href="{{ route('admin.homepagemanagement.index') }}">
                        <i class="fa fa-fw fa-lg fa-times-circle"></i>Back
                    </a>
                </div>
                <form action="{{ route('admin.homepagemanagement.update') }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="tile-footer">
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <a class="btn btn-secondary" href="{{ route('admin.homepagemanagement.index') }}"><i
