    ...
    <div class="app-title">
        <div class="row w-100 mx-0">
            ...
            <div class="col-md-6 text-right">
                <a href="{{ route('admin.language.master.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Create New</a>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row mx-0 align-items-center justify-content-between">
                <div class="col">
                    <p class="text-muted">Total Number of Records ({{$languages->total()}})</p>
                </div>
                <div class="col-auto">
                    <form action="">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group" aria-label="Second group">
                                            <a href="{{ route('admin.language.master.edit', $data['id']) }}" class="btn btn-sm btn-primary edit-btn"><i class="fa fa-edit"></i></a>
    ...
    <script type="text/javascript">
        ...
        $('input[id="toggle-block"]').change(function() {
          ...
          $.ajax({
                type:'POST',
                dataType:'JSON',
                url:"{{route('admin.language.master.updateStatus')}}",
