...
class ArticleController extends BaseController
{
    ...
    public function __construct(ArticleContract $ArticleRepository)
    {
    ...
    public function index(Request $request)
    {
        if (!empty($request->term)) {
            $article = $this->ArticleRepository->getSearchBlog($request->term);
        } else {
    ...
    public function create()
    {
        $this->setPageTitle('Article', 'Create Article');
         $blogcat = $this->ArticleRepository->getBlogcategories();
        $blogsubcat = $this->ArticleRepository->getBlogsubcategories();
        return view('admin.article.create', compact('blogcat', 'blogsubcat', 'blogtercat'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $article = $this->ArticleRepository->createBlog($request->except('_token'));
    ...
    {
        $targetblog = $this->ArticleRepository->findBlogById($id);
        $blogcat = $this->ArticleRepository->getBlogcategories();
        $blogsubcat = $this->ArticleRepository->getBlogsubcategories();
        $this->setPageTitle('Article', 'Edit Article : ' . $targetblog->title);
        return view('admin.article.edit', compact('targetblog', 'blogcat', 'blogsubcat'));
    }
    ...
    public function update(Request $request)
    {
        ...
        $targetblog = $this->ArticleRepository->updateBlog($params);
    ...
    {
        $targetblog = $this->ArticleRepository->deleteBlog($id);
    ...
    public function updateStatus(Request $request)
    {
        ...
        $targetblog = $this->ArticleRepository->updateBlogStatus($params);
    ...
    public function blogupdateStatus(Request $request)
    {
        ...
        $targetblog = $this->ArticleRepository->updateLatestBlogStatus($params);
    ...
    {
        $targetblog = $this->ArticleRepository->Articledetails($id);
        $article = $targetblog[0];
