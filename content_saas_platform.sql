...
--
-- Database: `content_saas_platform`
--
...
CREATE TABLE `articles` (
  ...
  `article_sub_category_id` int NOT NULL,
  `article_tertiary_category_id` int NOT NULL,
  ...
  `sticky_heading` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `sticky_content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `sticky_btn` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `sticky_btn_link` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `sticky_image` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `carts` (
  ...
  `course_slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `carts` (`id`, `ip`, `user_id`, `course_id`, `course_name`, `course_image`, `course_slug`, `author_name`, `price`, `offer_price`, `qty`, `coupon_code_id`, `status`, `created_at`) VALUES
(2, '103.75.162.68', NULL, 1, 'Mastering Digital PR with Brian Dean', NULL, 'mastering-digital-pr-with-brian-dean', 'https://demo91.co.in/laravel-only/ContentSaas/public/Robert', 3999.00, 0.00, 1, NULL, 1, '2022-09-12 13:12:55'),
(3, '157.40.116.7', NULL, 1, 'Mastering Digital PR with Brian Dean', NULL, 'mastering-digital-pr-with-brian-dean', 'Robert', 3999.00, 0.00, 1, NULL, 1, '2022-09-14 06:18:54'),
(5, '49.37.45.73', NULL, 2, 'Why do we use it', NULL, 'why-do-we-use-it', 'test author', 0.00, 0.00, 1, NULL, 1, '2022-09-14 16:28:35');
...
CREATE TABLE `certificates` (
  ...
  `certificate_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `long_desc` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `certificates` (`id`, `user_id`, `certificate_title`, `certificate_type`, `file`, `short_desc`, `long_desc`, `link`, `created_at`) VALUES
(1, 1, 'SEO Expert', 'Search Engine Optimisation', '', 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Placeat atque, veniam nobis sit modi eum molestiae voluptatibus. Mollitia possimus id harum cum pariatur dolores, iste ut est quos facere enim!', '', '', '2022-09-11 13:12:52');
...
INSERT INTO `clients` (`id`, `user_id`, `client_name`, `occupation`, `phone_number`, `email_id`, `image`, `short_desc`, `long_desc`, `link`, `created_at`) VALUES
...
CREATE TABLE `courses` (
  ...
  `key_module` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `course_content` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `company_description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `author_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `author_description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `course_quizzes` (
  ...
  `optionA` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `optionB` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `optionC` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `optionD` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `right_answer` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` tinyint NOT NULL DEFAULT '1' COMMENT '1: active, 0: inactive',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `course_slides` (
  ...
  `slide_content` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `course_topics` (
  ...
  `topic` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `assignment` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `assignment_file` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `status` tinyint NOT NULL DEFAULT '1' COMMENT '1: active, 0: inactive',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `education` (
  ...
  `college_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'college/ school',
  `year_from` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `year_to` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `education` (`id`, `user_id`, `degree`, `college_name`, `year_from`, `year_to`, `position`, `score`, `email_id`, `image`, `short_desc`, `long_desc`, `link`, `created_at`) VALUES
(1, 1, 'Marketing', 'Chartland institute of marketing', '2012', '2016', 3, '', '', '', '', '', '', '2022-09-11 13:22:09'),
(2, 1, 'Schooling', 'JN Roy School', '2000', '2010', 1, '', '', '', '', '', '', '2022-09-11 13:23:20'),
(3, 1, 'College', 'RERF', '2011', '2012', 2, '', '', '', '', '', '', '2022-09-11 13:23:48');
...
CREATE TABLE `employments` (
  ...
  `year_from` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `year_to` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `phone_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `email_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `owner_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `namager_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `short_desc` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `long_desc` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
INSERT INTO `employments` (`id`, `user_id`, `company_title`, `occupation`, `year_from`, `year_to`, `phone_number`, `email_id`, `image`, `owner_name`, `namager_name`, `short_desc`, `long_desc`, `link`, `created_at`) VALUES
(1, 1, 'Bough Digital', 'Managing Director', 'January 2010', 'Present', '', '', '', '', '', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi labore ea velit minus odit vero enim inventore consequuntur quis, voluptas cumque ipsam neque et perferendis non obcaecati repellendus repellat dicta.', '', '', '2022-09-11 13:49:23');
...
CREATE TABLE `events` (
  ...
  `content_type` int NOT NULL DEFAULT '1' COMMENT '1: online, 2: in-person',
  `online_link` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `event_link` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `business_id` int DEFAULT NULL,
  `contact_email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `contact_phone` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `event_host` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `language_id` int DEFAULT NULL,
  `format_id` int DEFAULT NULL,
  `is_paid` int NOT NULL DEFAULT '0',
  `event_cost` double(8,2) DEFAULT NULL,
  `is_recurring` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `feedbacks` (`id`, `user_id`, `date_from`, `date_to`, `title`, `rating`, `review`, `description`, `status`, `updated_at`) VALUES
(1, 1, '2022-08-11', '2022-09-25', 'Courses Completed', '3.5', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti tenetur consequatur animi quas, quaerat ipsum officiis, eos porro ad nam quibusdam natus velit dolores doloribus enim, in voluptatem temporibus error culpa ratione molestiae maxime veritatis? Corporis sequi nam facilis assumenda.', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti tenetur consequatur animi quas, quaerat ipsum officiis, eos porro ad nam quibusdam natus velit dolores doloribus enim, in voluptatem temporibus error culpa ratione molestiae maxime veritatis? Corporis sequi nam facilis assumenda.', 1, '2022-09-25'),
...
INSERT INTO `languages` (`id`, `name`, `icon`, `position`, `created_at`) VALUES
(1, 'English', NULL, 1, '2022-09-11 08:21:29'),
(2, 'Spanish', NULL, 1, '2022-09-11 08:21:29'),
(3, 'Portuguese', NULL, 1, '2022-09-11 08:21:29');
...
INSERT INTO `lessons` (`id`, `title`, `slug`, `image`, `description`, `status`, `created_at`) VALUES
(1, 'Random', 'random', 'uploads/lessons/633eaedc1d96a22-10-06-10-33-00.jpeg', 'qwerty', 1, '2022-10-06 02:49:16');
...
(1, 1, 4, '2022-10-07 14:05:41'),
(2, 1, 4, '2022-10-07 14:09:04'),
(3, 1, 5, '2022-10-07 14:09:05'),
(4, 1, 6, '2022-10-07 14:09:05');
...
CREATE TABLE `markets` (
  ...
  `slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `short_description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `market_btn` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `market_btn_link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `image` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `short_content_heading` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `short_content` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `short_content_btn` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `short_content_btn_link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sticky_content_heading` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sticky_content` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sticky_content_btn` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sticky_content_btn_link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `medium_content_heading` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `medium_content` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `faq_heading` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `faq_short` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `faq_banner_image` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `market_banners` (
  `id` bigint UNSIGNED NOT NULL,
  `content_heading` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content_btn` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content_btn_link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `image` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `market_categories` (
  ...
  `slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `image` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `category_description_heading` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `category_description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `category_description_image` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `category_description_btn` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `category_description_btn_link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` tinyint NOT NULL DEFAULT '1' COMMENT '1: active, 0: inactive',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `orders` (
  ...
  `payment_method` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'cash_on_delivery' COMMENT 'online_payment/ cash_on_delivery',
  ...
  `orderCancelledBy` tinyint NOT NULL DEFAULT '0' COMMENT '0: admin, 1:customer',
  `orderCancelledReason` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `orders` (`id`, `course_id`, `order_no`, `ip`, `user_id`, `fname`, `lname`, `email`, `mobile`, `alt_mobile`, `billing_address_id`, `billing_address`, `billing_landmark`, `billing_country`, `billing_state`, `billing_city`, `billing_pin`, `shippingSameAsBilling`, `shipping_address_id`, `shipping_address`, `shipping_landmark`, `shipping_country`, `shipping_state`, `shipping_city`, `shipping_pin`, `amount`, `shipping_charges`, `shipping_method`, `tax_amount`, `discount_amount`, `coupon_code_id`, `final_amount`, `gst_no`, `payment_method`, `is_paid`, `txn_id`, `status`, `orderCancelledBy`, `orderCancelledReason`, `created_at`) VALUES
(1, 1, 'Copywriter64556993', '157.40.98.161', 1, NULL, NULL, 'suvajit.bardhan@onenesstechs.in', '9038775709', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, 3999.00, 0.00, 'standard', 0.00, 0.00, 0, 3999.00, NULL, 'cash_on_delivery', 0, 0, 1, 0, NULL, '2022-09-12 15:15:20'),
(2, 1, 'Copywriter1001835840', '43.231.243.101', 1, 'Suvajit', 'Bardhan', 'suvajit.bardhan@onenesstechs.in', '9038775709', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, 3999.00, 0.00, 'standard', 0.00, 0.00, 0, 3999.00, NULL, 'cash_on_delivery', 0, 0, 1, 0, NULL, '2022-09-15 01:24:38');
...
INSERT INTO `portfolios` (`id`, `user_id`, `category`, `title`, `image`, `tags`, `short_desc`, `long_desc`, `link`, `created_at`) VALUES
(1, 1, 'Market Research', 'Test Portfolio title 1', 'frontend/img/research3.png', '', 'Pellentesque ullamcorper lectus non orci fermentum, tempus dapibus magna fermentum.', '', 'https://www.lipsum.com/', '2022-09-11 15:17:29'),
(2, 1, 'Market Research', 'Test Portfolio title 2', 'frontend/img/research2.png', '', 'Pellentesque ullamcorper lectus non orci fermentum, tempus dapibus magna fermentum.', '', 'https://www.lipsum.com/', '2022-09-11 15:18:35');
...
INSERT INTO `social_media` (`id`, `name`, `icon`, `position`, `link`, `created_at`) VALUES
(1, 'Facebook', '<i class=\"fa-brands fa-facebook-f\"></i>', 1, NULL, '2022-09-11 08:21:29'),
(2, 'Twitter', '<i class=\"fa-brands fa-twitter\"></i>', 1, NULL, '2022-09-11 08:21:29'),
(3, 'Instagram', '<i class=\"fa-brands fa-instagram\"></i>', 1, NULL, '2022-09-11 08:21:29'),
(4, 'Reddit', '<i class=\"fa-brands fa-reddit\"></i>', 1, NULL, '2022-09-11 08:21:29'),
(5, 'Telegram', '<i class=\"fa-brands fa-telegram\"></i>', 1, NULL, '2022-09-11 08:21:29'),
(6, 'Youtube', '<i class=\"fa-brands fa-youtube\"></i>', 1, NULL, '2022-09-11 08:21:29');
...
INSERT INTO `specialities` (`id`, `name`, `icon`, `short_desc`, `long_desc`, `position`, `created_at`) VALUES
(1, 'blog writing', NULL, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.', '', 1, '2022-09-11 08:21:30'),
(2, 'articles', NULL, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.', '', 1, '2022-09-11 08:21:30'),
(3, 'press releases', NULL, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.', '', 1, '2022-09-11 08:21:30'),
(4, 'journalism', NULL, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.', '', 1, '2022-09-11 08:21:30'),
(5, 'advertorials ', NULL, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.', '', 1, '2022-09-11 08:21:30');
...
CREATE TABLE `supports` (
  ...
  `widget_description` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `testimonials` (
  ...
  `email_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `short_testimonial` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `long_testimonial` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `testimonials` (`id`, `user_id`, `client_name`, `occupation`, `phone_number`, `email_id`, `image`, `short_testimonial`, `long_testimonial`, `link`, `created_at`) VALUES
(1, 1, 'Lisa Kudrow', 'Writer', '', '', 'frontend/img/writer3.png', 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Placeat atque, veniam nobis sit modi eum molestiae voluptatibus. Mollitia possimus id harum cum pariatur dolores, iste ut est quos facere enim!', '', '', '2022-09-11 13:17:19');
...
INSERT INTO `topics` (`id`, `title`, `slug`, `image`, `description`, `status`, `created_at`) VALUES
(4, 'Topic 1', 'topic-1', 'uploads/topic/63402ba46f33322-10-07-01-37-40.jpeg', '<p>New Topic</p>', 0, '2022-10-07 08:07:40'),
(5, 'Topic 2', 'topic-2', 'uploads/topic/63402bc1cef5e22-10-07-01-38-09.png', '<p>New topic 2</p>', 0, '2022-10-07 08:08:09'),
(6, 'New Topic 3', 'new-topic-3', 'uploads/topic/634032e59d55b22-10-07-02-08-37.png', '<p>New topic 3 post</p>', 0, '2022-10-07 08:38:37');
...
CREATE TABLE `users` (
  `id` bigint UNSIGNED NOT NULL,
  `type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '1:Writers 2: Employers 3: Publishers 4: Bloggers',
  ...
  `short_desc` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Short Description/ headline (4-5 words)',
  `long_desc` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Long description/ bio',
  ...
  `worked_for` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'comma seperated',
  `categories` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'comma seperated',
  `intro_video` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `quote` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `quote_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `color_scheme` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
(47, 1, 1, '2022-09-29 04:49:15'),
(48, 1, 2, '2022-09-29 04:49:15');
...
INSERT INTO `user_social_media` (`id`, `user_id`, `social_media_id`, `link`, `created_at`) VALUES
(108, 1, 1, 'https://facebook.com', '2022-09-29 04:49:15'),
(109, 1, 2, 'https://twitter.com', '2022-09-29 04:49:15'),
(110, 1, 6, 'https://youtube.com', '2022-09-29 04:49:15');
...
INSERT INTO `user_specialities` (`id`, `user_id`, `speciality_id`, `description`, `created_at`) VALUES
(2, 1, 5, 'Lorem Ipsum Is Simply Dummy Text Of The Printing And Typesetting Industry. Lorem Ipsum Has Been The Industry\'s Standard Dummy Text Ever Since The 1500s, When An Unknown Printer Took A Galley Of Type And Scrambled It To Make A Type Specimen Book.', '2022-09-26 08:01:29');
