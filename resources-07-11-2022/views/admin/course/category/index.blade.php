    ...
    <div class="app-title">
        <div class="row w-100">
            ...
            <div class="col-md-6 text-right">
                <a href="{{ route('admin.course-category.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>
                <a href="#csvUploadModal" data-toggle="modal" class="btn btn-primary "><i class="fa fa-cloud-upload"></i> CSV Upload</a>
                <a href="{{ route('admin.course-category.data.csv.export') }}" class="btn btn-primary "><i class="fa fa-cloud-download"></i> CSV Export</a>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-auto">
                    <form action="{{ route('admin.course-category.index') }}">
                            ...
                            @foreach($categories as $key => $category)
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group" aria-label="Second group">
                                        <a href="{{ route('admin.course-category.edit', $category['id']) }}" class="btn btn-sm btn-primary edit-btn"><i class="fa fa-edit"></i></a>
                                        <a href="{{ route('admin.course-category.details', $category['id']) }}" class="btn btn-sm btn-primary edit-btn"><i class="fa fa-eye"></i></a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('admin.course-category.data.csv.store')}}" enctype="multipart/form-data" id="fileCsvUploadForm">
                        @csrf
...
@push('scripts')
    ...
    $('.sa-remove').on("click",function(){
        ...
        function(isConfirm){
          if (isConfirm) {
            window.location.href = "course-category/"+categoryid+"/delete";
            } else {
    ...
    <script type="text/javascript">
        $('input[id="toggle-block"]').change(function() {
          ...
          $.ajax({
                type:'POST',
                dataType:'JSON',
                url:"{{route('admin.course-category.updateStatus')}}",
