        ...
        <div class="row w-100">
            ...
            <div class="col-md-6 text-right">
               ...
               {{--   <a href="#csvUploadModal" data-toggle="modal" class="btn btn-primary "><i class="fa fa-cloud-upload"></i> CSV Upload</a>
                <a href="{{ route('admin.market.data.data.csv.export') }}" class="btn btn-primary "><i class="fa fa-cloud-download"></i> CSV Export</a>--}}
            </div>
        </div>
    </div>
            ...
            <div class="tile">
                <div class="tile-body">
                    <table class="table table-hover custom-data-table-style table-striped">
                        ...
                        <tbody>
                            @foreach($support as $key => $data)
                                <tr>
                                    <td>{{ ($support->firstItem()) + $key }}</td>
                                    <td>
                                        @if($data->image!='')
                                        <img style="width: 100px;height: 100px;" src="{{asset($data->image)}}">
                                        @endif
                                    </td>
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group" aria-label="Second group">
                                        <a href="{{ route('admin.support.widget.edit', $data['id']) }}" class="btn btn-sm btn-primary edit-btn"><i class="fa fa-edit"></i></a>
                                        <a href="{{ route('admin.support.widget.details', $data['id']) }}" class="btn btn-sm btn-primary edit-btn"><i class="fa fa-eye"></i></a>
                                        <a href="{{ route('admin.support.widget.delete', $data['id']) }}" class="btn btn-sm btn-primary edit-btn"><i class="fa fa-trash"></i></a>
                                    </div>
                                </td>
                                </tr>
                            @endforeach
...
@push('scripts')
    ...
    $('.sa-remove').on("click",function(){
        ...
        function(isConfirm){
          if (isConfirm) {
            window.location.href = "https://demo91.co.in/laravel-only/ContentSaas/public/admin/support/widget/"+dataid+"/delete";
            } else {
